...
# TwoBeatJoinTransform intrinsic motion
TWO_BEAT_MOTION = 0.42
...
TWO_BEAT_WEAK_BEAT = 0.15
# For every chord beyond one which this note spans, increase score by 0.04 (0.04 max of course)
TWO_BEAT_MULTIPLE_CHORDS = 0.04

# ThreeBeatJoinTransform intrinsic motion
THREE_BEAT_MOTION = 0.34
# ThreeBeatJoin Transform intrinsic musicality.
THREE_BEAT_MUSICALITY = 0.01
# Slightly prefer the first beat of a the measure
...
# FourBeatJoinTransform intrinsic motion
FOUR_BEAT_MOTION = 0.26
# FourBeatJoinTransform intrinsic musicality.
FOUR_BEAT_MUSICALITY = 0.15
# Slightly prefer the first beat of a the measure
...
# FiveBeatJoinTransform intrinsic motion
FIVE_BEAT_MOTION = 0.18
# FiveBeatJoinTransform intrinsic musicality.
FIVE_BEAT_MUSICALITY = 0.20
# Slightly prefer the first beat of a the measure
...
# SixBeatJoinTransform intrinsic motion
SIX_BEAT_MOTION = 0.10
# SixBeatJoinTransform intrinsic musicality.
SIX_BEAT_MUSICALITY = 0.25
